...
- Run `uv sync` to install dependencies after cloning.
...
- Do not use `typing.List`, `typing.Optional`, `typing.Union`.
...
```python
def get_users(is_active: bool, user_count: int) -> list[User]:
